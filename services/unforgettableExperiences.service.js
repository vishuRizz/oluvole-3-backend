...
const create = asyncErrorHandler(async (req, res) => {
  ...
  if (createDaypass) {
    AdminLogEvent(req.body.adminId,'None','Added New Unforgettable Experiences','Success',"Successfully Added New Unforgettable Experiences ("+createDaypass.title+") ",createDaypass._id)
...
const update = asyncErrorHandler(async (req, res) => {
  ...
  if (updateData) {
    AdminLogEvent(req.body.adminId,'None','Update Unforgettable Experiences','Success',"Successfully Updated Unforgettable Experiences ("+updateData.title+") ",updateData._id)
...
const del = asyncErrorHandler(async (req, res) => {
  ...
  if (allDaypass) {
    AdminLogEvent(req.body.adminId,'None','Delete Unforgettable Experience','Success',"Successfully Deleted Unforgettable Experiences ("+allDaypass.title+") ",allDaypass._id)
